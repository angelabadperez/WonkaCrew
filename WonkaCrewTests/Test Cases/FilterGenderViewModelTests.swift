//
//  FilterGenderViewModelTests.swift
//  WonkaCrewTests
//
...
class FilterGenderViewModelTests: XCTestCase {
    
    // MARK: - Properties
    
    var viewModel: FilterGenderViewModel!
    ...
    override func setUpWithError() throws {
        ...
        viewModel = filtersViewModel.viewModel(for: IndexPath(row: 0, section: 0)) as? FilterGenderViewModel
    }
    ...
    func testText() {
        XCTAssertEqual(viewModel.text, "Male")
    }
